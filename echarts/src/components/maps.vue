...
export default {
  ...
  mounted(){
      ...
      this.delGeo();
      let myChar=Echart.init(document.getElementById("map"));
    //   let that=this;
    //   myChar.on('mouseover',function(param){
    //         let val='';
    //         if(param.value){
    //             val=that.value+param.value[param.value.length-1];
    //         }
    //         that.cityoption.tooltip.formatter=val;
    //         myChar.setOption(that.cityoption);
    //   });
